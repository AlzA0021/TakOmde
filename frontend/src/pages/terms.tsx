  ...
  const sections = [
    {
      title: '۱. کلیات',
      content: [
        'این قوانین و مقررات برای تمامی کاربران فروشگاه آنلاین بنکداری شقایق لازم‌الاجرا است.',
        'با استفاده از خدمات این فروشگاه، شما این قوانین را پذیرفته‌اید.',
        'فروشگاه بنکداری شقایق حق تغییر این قوانین را بدون اطلاع قبلی دارد.',
      ],
    },
    {
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-8 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-yellow-800 text-sm leading-relaxed">
              با ثبت سفارش و استفاده از خدمات فروشگاه آنلاین بنکداری شقایق شما تمامی قوانین و
