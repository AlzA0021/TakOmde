...
class Product(models.Model):
    ...
    sku = models.CharField(max_length=100, unique=True, help_text='کد کالا از نرم‌افزار حسابداری')
    description = models.TextField(blank=True, null=True)
    ...
    sale_price = models.DecimalField(max_digits=12, decimal_places=0, null=True, blank=True, help_text='قیمت تخفیف‌خورده')
    ...
    weight = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, help_text='وزن به گرم')
