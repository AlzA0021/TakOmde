"""
Django settings for pickbazar_shop project.
"""
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # برای سرو static files در production
...
ROOT_URLCONF = 'pickbazar_shop.urls'
...
WSGI_APPLICATION = 'pickbazar_shop.wsgi.application'
...
ZARINPAL_SANDBOX = DEBUG

PAYPINT_TOKEN = config('PAYPINT_TOKEN', default='')
PAYPINT_CALLBACK_URL = config('PAYPINT_CALLBACK_URL', default='')
...
# پشتیبانی از REDIS_URL برای Render.com
